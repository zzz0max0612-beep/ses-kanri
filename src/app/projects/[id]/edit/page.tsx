  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setForm({
        ...
        provider_company: project.provider_company ?? '',
  ...
  return (
    <main className="max-w-xl mx-auto px-4 py-8">
      ...
      <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
        <label className="block text-sm font-medium mb-2">案件情報から上書き入力（任意）</label>
        <textarea
          value={projectText}
